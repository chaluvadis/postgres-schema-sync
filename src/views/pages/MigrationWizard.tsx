...
const AnalyzeChangesStep: React.FC<AnalyzeChangesStepProps> = ({
  analyzing,
  onAnalyze,
  onBack,
  canProceed
...
const ReviewScriptStep: React.FC<ReviewScriptStepProps> = ({
  script,
  onExecute,
  onBack
}) => {
  const getRiskColor = (risk: string) => {
    switch (risk) {
      case 'critical': return vscodeTheme.colors.error;
      case 'high': return vscodeTheme.colors.error;
      case 'medium': return vscodeTheme.colors.warning;
      case 'low': return vscodeTheme.colors.success;
      default: return vscodeTheme.colors.foreground;
    }
  };
        ...
        <div style={{
          ...
          {script.migrationSteps.map((step, index) => (
            <div
              ...
              style={{
                padding: vscodeTheme.spacing.md,
                borderBottom: index < script.migrationSteps.length - 1
                  ? `1px solid ${vscodeTheme.colors.border}`
                  : 'none',
                backgroundColor: index % 2 === 0
                  ? vscodeTheme.colors.background
                  : vscodeTheme.colors.inputBackground
              }}
            >
              <div style={{
                display: 'flex',
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: result.success
                    ? vscodeTheme.colors.success
                    : vscodeTheme.colors.error,
                  color: vscodeTheme.colors.background,
                  fontSize: vscodeTheme.typography.fontSize.sm
                }}
              >
                <div style={{ fontWeight: 600, marginBottom: vscodeTheme.spacing.xs }}>
...
const CompleteStep: React.FC<CompleteStepProps> = ({
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: vscodeTheme.spacing.md }}>
