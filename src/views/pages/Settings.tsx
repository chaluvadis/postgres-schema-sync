    ...
    <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: activeTab === tab.id
                    ? vscodeTheme.colors.listActiveSelectionBackground
                    : 'transparent',
                  color: vscodeTheme.colors.foreground,
                  border: 'none',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: vscodeTheme.spacing.sm }}>
          <Button
            onClick={() => vscode.postMessage({ command: 'showDashboard' })}
            variant="secondary"
            size="sm"
          >
            Cancel
...
const GeneralSettings: React.FC<SettingsProps> = ({ settings, onSettingChange }) => {
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: vscodeTheme.spacing.lg }}>
        {/* Schema Comparison */}
        <SettingGroup title="Schema Comparison">
          <SettingItem
            label="Comparison Mode"
            description="How strictly to compare schema objects"
          >
            <select
          ...
          <SettingItem
            label="Ignore Schemas"
            description="Comma-separated list of schemas to ignore during comparison"
          >
            <input
              type="text"
        ...
        <SettingGroup title="User Interface">
          <SettingItem
            ...
            description="Show notifications for operation status"
          >
            <Toggle
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: vscodeTheme.spacing.lg }}>
        ...
        <SettingGroup title="Security Manager">
          ...
          <SettingItem
            ...
            description="Overall security level for certificate validation"
          >
            <select
        ...
        <SettingGroup title="Certificate Validation">
          ...
          >
            <Toggle
              ...
              onChange={(checked) => onSettingChange('postgresql.securityManager.certificateValidation.enabled', checked)}
            />
          </SettingItem>
          ...
          >
            <Toggle
              ...
              onChange={(checked) => onSettingChange('postgresql.securityManager.certificateValidation.allowSelfSigned', checked)}
            />
          </SettingItem>
        </SettingGroup>
      </div>
        ...
        <SettingGroup title="Performance Monitoring">
          ...
          >
            <input
              ...
              onChange={(e) => onSettingChange('postgresql.performanceMonitoring.slowQueryThreshold', parseInt(e.target.value))}
              style={getInputStyle()}
            />
          </SettingItem>
          ...
          >
            <input
              ...
              onChange={(e) => onSettingChange('postgresql.performanceMonitoring.alertCooldown', parseInt(e.target.value))}
              style={getInputStyle()}
            />
          </SettingItem>
        </SettingGroup>
...
const SettingGroup: React.FC<SettingGroupProps> = ({ title, children }) => {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: vscodeTheme.spacing.md }}>
        {children}
      </div>
    </div>
  );
