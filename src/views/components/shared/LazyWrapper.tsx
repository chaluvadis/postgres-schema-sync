...
export class LazyWrapper extends React.Component<LazyWrapperProps, LazyWrapperState> {
	...
	render() {
		...
		return <Suspense fallback={this.props.fallback || <DefaultLoadingFallback />}>{this.props.children}</Suspense>;
	}
}
...
const DefaultErrorFallback: React.FC<{ error: Error; retry: () => void }> = ({ error, retry }) => (
	...
	>
		<div style={{ fontWeight: "bold", marginBottom: vscodeTheme.spacing.sm }}>Failed to load component</div>
		<div
			style={{
				fontSize: "12px",
