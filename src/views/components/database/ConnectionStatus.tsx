...
export const ConnectionStatus: React.FC<ConnectionStatusProps> = ({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'connected': return vscodeTheme.colors.success;
      case 'error': return vscodeTheme.colors.error;
      case 'disconnected': return vscodeTheme.colors.warning;
