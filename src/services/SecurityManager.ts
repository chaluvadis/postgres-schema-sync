...
export class SecurityManager {
  ...
  private certificateCache: Map<
    string,
    { cert: CertificateInfo; timestamp: number }
  > = new Map();
  ...
  private loadSecurityConfiguration(): SecurityConfiguration {
    ...
    return {
      ...
      certificateValidation: {
        ...
        checkRevocation: vscodeConfig.get(
          "certificateValidation.checkRevocation",
          false
        ),
        checkTransparency: vscodeConfig.get(
          "certificateValidation.checkTransparency",
          false
        ),
        allowSelfSigned: vscodeConfig.get(
          "certificateValidation.allowSelfSigned",
          false
        ),
        minKeySize: vscodeConfig.get("certificateValidation.minKeySize", 2048),
        maxValidityDays: vscodeConfig.get(
          "certificateValidation.maxValidityDays",
          825
        ),
      },
      certificatePinning: {
        enabled: vscodeConfig.get("certificatePinning.enabled", false),
        autoPinTrusted: vscodeConfig.get(
          "certificatePinning.autoPinTrusted",
          false
        ),
        requireUserApproval: vscodeConfig.get(
          "certificatePinning.requireUserApproval",
          true
        ),
        maxPinAge: vscodeConfig.get("certificatePinning.maxPinAge", 365),
        allowedHostnames: vscodeConfig.get(
          "certificatePinning.allowedHostnames",
          []
        ),
      },
      monitoring: {
        enabled: vscodeConfig.get("monitoring.enabled", true),
        alertLevels: vscodeConfig.get("monitoring.alertLevels", [
          "warning",
          "error",
          "critical",
        ]),
        ...
        autoResolveAfterDays: vscodeConfig.get(
          "monitoring.autoResolveAfterDays",
          30
        ),
        showNotifications: vscodeConfig.get(
          "monitoring.showNotifications",
          true
        ),
        showInStatusBar: vscodeConfig.get("monitoring.showInStatusBar", true),
      },
      connectionSecurity: {
        enforceSecureConnections: vscodeConfig.get(
          "connectionSecurity.enforceSecureConnections",
          false
        ),
        allowInsecureFallback: vscodeConfig.get(
          "connectionSecurity.allowInsecureFallback",
          true
        ),
        validateOnConnect: vscodeConfig.get(
          "connectionSecurity.validateOnConnect",
          true
        ),
        validateOnReconnect: vscodeConfig.get(
          "connectionSecurity.validateOnReconnect",
          true
        ),
      },
      sqlInjection: {
        ...
        allowUnparameterizedDML: vscodeConfig.get(
          "sqlInjection.allowUnparameterizedDML",
          false
        ),
        logOnly: vscodeConfig.get("sqlInjection.logOnly", false),
        maxQueryLength: vscodeConfig.get("sqlInjection.maxQueryLength", 100000),
        allowedKeywords: vscodeConfig.get("sqlInjection.allowedKeywords", [
          "SELECT",
          "INSERT",
          "UPDATE",
          "DELETE",
      ...
      passwordPolicy: {
        ...
        preventCommonPasswords: vscodeConfig.get(
      ...
      rateLimiting: {
        ...
        maxConnectionAttempts: vscodeConfig.get(
          "rateLimiting.maxConnectionAttempts",
          5
        ),
        windowMs: vscodeConfig.get("rateLimiting.windowMs", 300000),
        maxQueriesPerMinute: vscodeConfig.get(
          "rateLimiting.maxQueriesPerMinute",
          100
        ),
        maxConnectionsPerUser: vscodeConfig.get(
          "rateLimiting.maxConnectionsPerUser",
          10
        ),
      },
      dataClassification: {
        ...
        autoClassifyPatterns: vscodeConfig.get(
          "dataClassification.autoClassifyPatterns",
          true
        ),
        requireApprovalForRestricted: vscodeConfig.get(
          "dataClassification.requireApprovalForRestricted",
          true
        ),
        maskingEnabled: vscodeConfig.get(
          "dataClassification.maskingEnabled",
          true
        ),
        encryptionEnabled: vscodeConfig.get(
          "dataClassification.encryptionEnabled",
          true
        ),
      },
      encryption: {
        enabled: vscodeConfig.get("encryption.enabled", true),
        defaultAlgorithm: vscodeConfig.get(
          "encryption.defaultAlgorithm",
          "AES-256-GCM"
        ),
        keyRotationDays: vscodeConfig.get("encryption.keyRotationDays", 90),
        encryptConnectionPasswords: vscodeConfig.get(
          "encryption.encryptConnectionPasswords",
          true
        ),
        encryptQueryResults: vscodeConfig.get(
          "encryption.encryptQueryResults",
          false
        ),
      },
      compliance: {
        enabled: vscodeConfig.get("compliance.enabled", false),
        frameworks: vscodeConfig.get("compliance.frameworks", [
          ComplianceFramework.GDPR,
        ]),
        reportingEnabled: vscodeConfig.get(
          "compliance.reportingEnabled",
          false
        ),
        reportFrequency: vscodeConfig.get(
          "compliance.reportFrequency",
          "monthly"
        ),
      ...
      networkSecurity: {
        ...
        firewallEnabled: vscodeConfig.get(
          "networkSecurity.firewallEnabled",
          true
        ),
        allowedPorts: vscodeConfig.get(
          "networkSecurity.allowedPorts",
          [5432, 5433]
        ),
        blockedCountries: vscodeConfig.get(
          "networkSecurity.blockedCountries",
          []
        ),
        maxConnectionsPerIP: vscodeConfig.get(
          "networkSecurity.maxConnectionsPerIP",
          10
        ),
        connectionTimeout: vscodeConfig.get(
          "networkSecurity.connectionTimeout",
          30000
        ),
        requireSSLForExternal: vscodeConfig.get(
          "networkSecurity.requireSSLForExternal",
          true
        ),
      ...
      vulnerabilityScanning: {
        ...
        scanOnConnect: vscodeConfig.get(
          "vulnerabilityScanning.scanOnConnect",
          false
        ),
        scanSchedule: vscodeConfig.get(
          "vulnerabilityScanning.scanSchedule",
          "weekly"
        ),
        autoRemediation: vscodeConfig.get(
          "vulnerabilityScanning.autoRemediation",
          false
        ),
        alertOnNewVulnerabilities: vscodeConfig.get(
          "vulnerabilityScanning.alertOnNewVulnerabilities",
          true
        ),
        maxScanDuration: vscodeConfig.get(
          "vulnerabilityScanning.maxScanDuration",
          300000
        ), // 5 minutes
      },
    };
  ...
  async validateCertificate(
    ...
    try {
      ...
      if (!this.config.certificateValidation.enabled) {
        Logger.info(
          "Certificate validation disabled, skipping",
          "validateCertificate"
        );
        return { valid: true };
      }
      ...
      if (cached && Date.now() - cached.timestamp < 300000) {
        ...
        return this.validateCertificateInfo(
          cached.cert,
          hostname,
          connectionId
        );
  ...
  private validateCertificateInfo(
    ...
    if (this.config.certificatePinning.enabled) {
      ...
      if (pinnedCert) {
        if (pinnedCert.fingerprint !== cert.fingerprint) {
          warnings.push(
            "Certificate fingerprint does not match pinned certificate"
          );
          if (this.config.securityLevel === "strict") {
            valid = false;
          }
    ...
    const validityDays = Math.ceil(
      (cert.validTo.getTime() - cert.validFrom.getTime()) /
        (1000 * 60 * 60 * 24)
    );
    ...
    if (
      cert.isSelfSigned &&
      !this.config.certificateValidation.allowSelfSigned
    ) {
  ...
  private addSecurityEvent(event: SecurityEvent): void {
    ...
    if (this.securityEvents.length > this.config.monitoring.maxEvents) {
      this.securityEvents = this.securityEvents.slice(
        -this.config.monitoring.maxEvents
      );
    }

    // Show notification if configured
    if (
      this.config.monitoring.showNotifications &&
      this.config.monitoring.alertLevels.includes(event.severity)
    ) {
  ...
  private showSecurityNotification(event: SecurityEvent): void {
    ...
    switch (event.severity) {
      ...
      case "high":
        vscode.window
          .showErrorMessage(message, "View Details", "Dismiss")
          .then((selection) => {
      ...
      case "medium":
        vscode.window
          .showWarningMessage(message, "View Details", "Dismiss")
          .then((selection) => {
            if (selection === "View Details") {
              this.showSecurityDetails(event);
            }
  ...
  private showSecurityDetails(event: SecurityEvent): void {
    const details = `
            ...
            ${
              event.details
                ? `- Additional Info: ${JSON.stringify(event.details, null, 2)}`
                : ""
            }
        `;
  ...
  private cleanupOldEvents(): void {
    const cutoffDate = new Date(
      Date.now() - this.config.monitoring.retentionDays * 24 * 60 * 60 * 1000
    );
  ...
  private async loadPinnedCertificates(): Promise<void> {
    try {
      ...
      if (!this.secrets) {
        Logger.warn(
          "VS Code secrets storage not available, using in-memory storage only",
      ...
      const pinnedCertsData = await this.secrets.get(
        "postgresql.pinnedCertificates"
      );
      ...
      if (pinnedCertsData) {
        try {
          ...
          for (const item of pinnedCertsArray) {
            ...
            if (this.validateCertificateIntegrity(item.certificate)) {
              ...
              Logger.warn(
                "Invalid pinned certificate data detected and skipped",
                "loadPinnedCertificates",
                {
                  hostname: item.hostname,
                }
          ...
          Logger.info(
            "Pinned certificates loaded from secret storage",
            "loadPinnedCertificates",
            {
          ...
          Logger.error(
            "Failed to parse pinned certificates data",
            parseError as Error,
            "loadPinnedCertificates"
          );
        ...
        Logger.info(
          "No pinned certificates found in secret storage",
          "loadPinnedCertificates"
        );
      }
    } catch (error) {
      Logger.error(
        "Failed to load pinned certificates",
        error as Error,
        "loadPinnedCertificates"
      );
    }
    ...
    try {
      ...
      for (const [hostname, certificate] of this.pinnedCertificates.entries()) {
        ...
        if (this.validateCertificateIntegrity(certificate)) {
          ...
          Logger.warn(
            "Skipping invalid certificate during save",
            "savePinnedCertificates",
            {
              hostname,
            }
      ...
      Logger.info(
        "Pinned certificates saved to secret storage",
        "savePinnedCertificates",
        {
      ...
      Logger.error(
        "Failed to save pinned certificates",
        error as Error,
        "savePinnedCertificates"
      );
    }
  ...
  private autoResolveEvents(): void {
    const cutoffDate = new Date(
      Date.now() -
        this.config.monitoring.autoResolveAfterDays * 24 * 60 * 60 * 1000
    );
    let resolvedCount = 0;
  ...
  checkRateLimit(
    ...
    if (!allowed) {
      retryAfter = Math.ceil(
        (rateLimitData.windowStart + windowMs - now) / 1000
      );
    ...
    return {
      ...
      reason: allowed
        ? undefined
        : `Maximum ${maxAttempts} attempts per ${Math.round(
            windowMs / 1000
          )}s window exceeded`,
    };
  }
  ...
  classifyData(data: string, context?: string): DataClassification {
    ...
    for (const rule of this.dataClassificationRules) {
      try {
        ...
        if (regex.test(data)) {
          if (
            this.getClassificationPriority(rule.classification) >
            this.getClassificationPriority(highestClassification)
          ) {
        ...
        Logger.warn(
          `Invalid regex pattern in classification rule ${rule.id}`,
          "classifyData"
        );
      }
    }
    ...
    if (context) {
      highestClassification = this.applyContextClassification(
        data,
        context,
  ...
  maskData(
    ...
    const rule = this.dataClassificationRules.find(
  ...
  async encryptSensitiveData(
    ...
    try {
      ...
      if (!key) {
        Logger.warn(
          "Encryption key not found, returning unencrypted data",
  ...
  async generateComplianceReport(
    ...
    if (
      !this.config.compliance.enabled ||
      !this.config.compliance.frameworks.includes(framework)
    ) {
    ...
    const highSeverityEvents = relevantEvents.filter(
    ...
    if (this.config.encryption.enabled) {
      const expiredKeys = Array.from(this.encryptionKeys.values()).filter(
        (k) => k.expires && k.expires < new Date()
      );
  ...
  async validateNetworkConnection(
    ...
    if (
      this.blockedConnections.has(hostname) ||
      this.blockedConnections.has(sourceIP || "")
    ) {
      return {
        allowed: false,
    ...
    if (
      this.config.networkSecurity.requireSSLForExternal &&
      this.isExternalHost(hostname) &&
      port !== 5432
    ) {
      return {
        allowed: false,
      ...
      if (
        ...
        const securityEvent: SecurityEvent = {
          ...
          details: {
            ...
            criticalFindings: scan.findings.filter(
  ...
  validateConnectionSecurity(
    ...
    if (this.config.connectionSecurity.enforceSecureConnections && !useSSL) {
      return {
        allowed: false,
        reason:
          "Secure connections are enforced but connection is not using SSL",
        requiresSSL: true,
      };
    }
  ...
  private validateParameterBinding(
    ...
    const namedParams =
      (sql.match(/@\w+/g) || []).length + (sql.match(/:\w+/g) || []).length;
    ...
    if (totalPlaceholders === 0 && parameters.length > 0) {
      ...
      recommendations.push(
        "Remove unused parameters or add proper placeholders"
      );
    }
    ...
    if (totalPlaceholders > 0 && parameters.length === 0) {
      ...
      recommendations.push(
        "Provide parameters for all placeholders or use literal values"
      );
    }

    if (parameters.length !== totalPlaceholders && totalPlaceholders > 0) {
      issues.push(
        `Parameter count mismatch: ${parameters.length} provided, ${totalPlaceholders} expected`
      );
    ...
    for (let i = 0; i < parameters.length; i++) {
      ...
      if (typeof param === "string" && param.length > 1000) {
        issues.push(
          `Parameter ${i + 1} is unusually long (${param.length} characters)`
        );
        recommendations.push(
          "Review long string parameters for potential injection"
        );
      }
    }
  ...
  private validateCertificateIntegrity(certificate: CertificateInfo): boolean {
    try {
      ...
      if (!fingerprintRegex.test(certificate.fingerprint)) {
        Logger.warn(
          "Certificate has invalid fingerprint format",
          "validateCertificateIntegrity"
        );
        return false;
      }
      ...
      if (isNaN(validFrom.getTime()) || isNaN(validTo.getTime())) {
        Logger.warn(
          "Certificate has invalid date format",
          "validateCertificateIntegrity"
        );
        return false;
      }
      ...
      if (certificate.keySize < 1024) {
        Logger.warn(
          "Certificate has insufficient key size",
          "validateCertificateIntegrity",
          {
      ...
      if (!certificate.algorithm || certificate.algorithm.length === 0) {
        Logger.warn(
          "Certificate missing algorithm information",
          "validateCertificateIntegrity"
        );
        return false;
      }
      ...
      Logger.error(
        "Certificate integrity validation failed",
        error as Error,
        "validateCertificateIntegrity"
      );
      return false;
  ...
  async pinCertificate(
    ...
    try {
      ...
      if (!this.validateCertificateIntegrity(certificate)) {
        Logger.error(
          "Cannot pin invalid certificate",
      ...
      if (this.config.certificatePinning.requireUserApproval && !userApproval) {
        Logger.warn(
          "Certificate pinning requires user approval",
          "pinCertificate",
          { hostname }
        );
        return false;
      ...
      if (
        ...
        Logger.warn(
          "Hostname not in allowed list for certificate pinning",
          "pinCertificate",
          { hostname }
        );
        return false;
  ...
  validateAgainstPinned(
    ...
    if (!pinnedCert) {
      return {
        ...
        reason: this.config.certificatePinning.enabled
          ? "No pinned certificate found for hostname"
          : undefined,
      };
    }
  ...
  async demonstrateComplianceFeatures(): Promise<void> {
    ...
    try {
      ...
      Logger.info("SOX Assessment Complete", "demonstrateComplianceFeatures", {
        ...
        compliantControls: soxFindings.filter((f) => f.status === "resolved")
          .length,
      });
    } catch (error) {
      Logger.error(
        "Compliance demonstration failed",
        error as Error,
  ...
  async demonstrateDataProtection(): Promise<void> {
    ...
    try {
      ...
      const hipaaEncrypted = await this.encryptSensitiveData(
        piiData,
        hipaaClassification
      );

      Logger.info(
        "Compliance-specific Data Protection",
      ...
      Logger.error(
        "Data protection demonstration failed",
        error as Error,
        "demonstrateDataProtection"
      );
    }
  ...
  runSecurityTests(): {
    ...
    try {
      ...
      results.passwordStrength =
        !weakResult.isAcceptable && strongResult.isAcceptable;
  ...
  private initializeDefaultClassificationRules(): void {
    ...
    Logger.info(
      "Default classification rules initialized",
  ...
  private applyContextClassification(
    ...
    if (
      contextLower.includes("config") ||
      contextLower.includes("system") ||
      contextLower.includes("settings")
    ) {
      suggestedClassification = DataClassification.INTERNAL;
    }
    ...
    if (
      contentAnalysis.sensitivityLevel >
      this.getClassificationPriority(currentClassification)
    ) {
      suggestedClassification = this.getClassificationByPriority(
        contentAnalysis.sensitivityLevel
      );
    }

    // Apply compliance framework requirements
    suggestedClassification = this.applyComplianceClassification(
      context,
  ...
  private analyzeDataContent(data: string): {
    ...
    const piiPatterns = [
      ...
      {
        pattern:
          /\b\d{1,4}[-\s.]?\(?[0-9]{3}\)?[-\s.]?[0-9]{3}[-\s.]?[0-9]{4}\b/g,
        name: "Phone",
        score: 6,
      },
      {
    ...
    const financialPatterns = [
      ...
      {
        pattern:
          /\b\d{1,3}(?:,?\d{3})*(?:\.\d{2})?\s*(?:USD|EUR|GBP|CAD|AUD)\b/g,
        name: "Amount",
        score: 7,
      },
    ];
  ...
  private applyComplianceClassification(
    ...
    if (
      this.config.compliance.frameworks.includes(ComplianceFramework.PCI_DSS)
    ) {
      if (
  ...
  private async getOrCreateEncryptionKey(
    ...
    let key = Array.from(this.encryptionKeys.values()).find(
      (k) => k.name === keyName
    );
    ...
    if (!key) {
      ...
      key = {
        ...
        keySize:
          this.config.encryption.defaultAlgorithm === "AES-256-GCM" ? 256 : 256,
        created: new Date(),
        expires: new Date(
          Date.now() +
  ...
  private getComplianceFrequencyMs(): number {
    ...
    return (
      frequencies[this.config.compliance.reportFrequency] || frequencies.monthly
    );
  }
  ...
  private async assessSOXCompliance(): Promise<ComplianceFinding[]> {
    ...
    if (!this.config.dataClassification.enabled) {
      findings.push({
        ...
        severity: "high",
        description:
          "Data classification not enabled - SOX requires proper access controls",
        status: "open",
        remediation:
          "Enable data classification to implement proper access controls",
  ...
  private initializeDefaultNetworkRules(): void {
    this.networkSecurityRules = [
      ...
      },
      {
        ...
        enabled: true,
        description:
          "Allow connections from private IP ranges (10.0.0.0/8, 192.168.0.0/16, 172.16.0.0/12)",
      },
      {
    ...
    Logger.info(
      "Default network security rules initialized",
      "initializeDefaultNetworkRules",
      {
  ...
  private async scanPorts(target: string): Promise<VulnerabilityFinding[]> {
    ...
    const commonPorts = [
      22, 23, 25, 53, 80, 110, 143, 443, 993, 995, 1433, 3306, 3389, 5432, 8080,
    ];
  ...
  private async scanConfiguration(
    ...
    const configIssues = [
      ...
      },
      {
        ...
        remediation:
          "Review and minimize user privileges using principle of least privilege",
        severity: "high" as const,
      },
    ];
...
`;
  ...
  async demonstrateRealtimeClassification(): Promise<void> {
    ...
    try {
      ...
      for (const testCase of testCases) {
        ...
        const contextClassification = this.classifyData(
          testCase.data,
          testCase.context
        );
        ...
        Logger.info(
          ...
          "demonstrateRealtimeClassification",
          {
            description: testCase.description,
            data:
              testCase.data.substring(0, 50) +
              (testCase.data.length > 50 ? "..." : ""),
            ...
            classificationUpgraded:
              contextClassification !== baseClassification,
          }
        );
      }
      ...
      const gdprData =
        "EU Customer: jean.dupont@france.fr, Phone: +33-1-23-45-67-89";
      const hipaaData =
        "Patient: Marie Smith, DOB: 03/15/1980, SSN: 123-45-6789";
      const pciData =
        "Cardholder: John Doe, Card: 4532-1234-5678-9012, Exp: 12/25";

      const gdprClassification = this.classifyData(
        gdprData,
        "GDPR customer data"
      );
      const hipaaClassification = this.classifyData(
        hipaaData,
        "HIPAA medical record"
      );
      const pciClassification = this.classifyData(
        pciData,
      ...
      Logger.error(
        "Realtime classification demonstration failed",
        error as Error,
        "demonstrateRealtimeClassification"
      );
    }
  ...
  async testCertificatePersistence(): Promise<{
    ...
    try {
      Logger.info(
        "Testing certificate persistence functionality",
        "testCertificatePersistence"
      );
      ...
      results.pin = await this.pinCertificate(
        testHostname,
        testCertificate,
        true
      );
      ...
      const validation = this.validateAgainstPinned(
        testHostname,
        testCertificate
      );
      ...
      const isUnpinned = !pinnedAfterUnpin.some(
        (pc) => pc.hostname === testHostname
      );

      Logger.info(
        "Certificate persistence test results",
        "testCertificatePersistence",
        {
          ...results,
      ...
      Logger.error(
        "Certificate persistence test failed",
        error as Error,
        "testCertificatePersistence"
      );
      return results;
