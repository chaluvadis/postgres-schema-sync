...
export class CommandManager {
    ...
    private registerCoreCommands(disposables: vscode.Disposable[]): void {
        const coreCommands = [
            ...
            },
            {
                ...
                handler: (connectionId?: string, schemaName?: string) => this.commandHandlers.handleBrowseSchema(connectionId, schemaName),
                description: 'Browse database schema'
            },
            {
                command: 'postgresql.compareSchemas',
                handler: (source?: DatabaseConnection, target?: DatabaseConnection) => this.commandHandlers.handleCompareSchemas(source, target),
    ...
    private registerAdditionalCommands(disposables: vscode.Disposable[]): void {
        ...
        this.commandRegistry.registerCommand('postgresql.openSettings', () => this.additionalCommandHandlers.openSettings());
    }
    ...
    private registerManageConnectionsCommand(disposables: vscode.Disposable[]): void {
        this.commandRegistry.registerCommand('postgresql.manageConnections', () => this.additionalCommandHandlers.manageConnections());
    }
    /**
    ...
    private registerUICommands(disposables: vscode.Disposable[]): void {
        ...
        this.commandRegistry.registerCommand('postgresql.showNotifications', () => this.uiCommandHandlers.showNotifications());
        this.commandRegistry.registerCommand('postgresql.showActiveOperations', () => this.uiCommandHandlers.showActiveOperations());
        this.commandRegistry.registerCommand('postgresql.showSchemaDriftReport', (comparisonId?: string) => this.uiCommandHandlers.showSchemaDriftReport(comparisonId));
        this.commandRegistry.registerCommand('postgresql.showQueryAnalytics', () => this.uiCommandHandlers.showQueryAnalytics());
    ...
    private registerQueryCommands(disposables: vscode.Disposable[]): void {
        this.commandRegistry.registerCommand('postgresql.openQueryEditor', (connection) => this.queryCommandHandlers.openQueryEditor(connection));
    ...
    private registerSQLFileCommands(disposables: vscode.Disposable[]): void {
        this.commandRegistry.registerCommand('postgresql.executeCurrentFile', () => this.sqlFileHandlers.executeCurrentSQLFile());
        this.commandRegistry.registerCommand('postgresql.formatCurrentFile', () => this.sqlFileHandlers.formatCurrentSQLFile());
    }
