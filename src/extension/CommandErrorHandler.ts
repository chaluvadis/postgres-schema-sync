...
export class CommandErrorHandler {
    ...
    clearCommandErrors(): void {
        ...
        Logger.info('Command error history cleared', 'CommandErrorHandler', { clearedCount });
    ...
    startCommandMonitoring(): void {
        ...
        Logger.info('Command health monitoring started', 'CommandErrorHandler', { intervalMinutes });
    }
