...
public class ErrorHandler
{
    ...
    private async Task<bool> HandlePostgresExceptionAsync(Exception exception)
    {
    ...
    private async Task<bool> HandleConnectionExceptionAsync(Exception exception)
    {
        _logger.LogWarning("Connection exception: {Message}", exception.Message);
        // Connection errors are typically retryable
        return true;
    }
    private async Task<bool> HandleSchemaExceptionAsync(Exception exception)
    {
        ...
        return exception.Message.Contains("timeout") || exception.Message.Contains("temporary");
    }
    private async Task<bool> HandleComparisonExceptionAsync(Exception exception)
    {
        _logger.LogWarning("Comparison exception: {Message}", exception.Message);
        // Comparison errors are usually not retryable
        return false;
    }
    private async Task<bool> HandleMigrationExceptionAsync(Exception exception)
    {
    ...
    private async Task<bool> HandleValidationExceptionAsync(Exception exception)
    {
        _logger.LogWarning("Validation exception: {Message}", exception.Message);
        // Validation errors are not retryable
        return false;
    }
    private async Task<bool> HandleCancellationExceptionAsync(Exception exception)
    {
    ...
    private async Task<bool> HandleTimeoutExceptionAsync(Exception exception)
    {
